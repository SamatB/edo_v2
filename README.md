...
<li>запусти docker-compose.yml <code>edo_db</code>. Он запустит необходимые контейнеры.Если у тебя уже установлен postgres,
работающий на порту 5432, его нужно выключить, либо изменить порт его работы.</li>
