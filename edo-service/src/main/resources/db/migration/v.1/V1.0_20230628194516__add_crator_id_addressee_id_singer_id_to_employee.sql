ALTER TABLE appeal ADD IF NOT EXISTS creator_id BIGSERIAL;
ALTER TABLE employee ADD IF NOT EXISTS singers_id BIGSERIAL;
ALTER TABLE employee ADD IF NOT EXISTS addressee_id BIGSERIAL;
ALTER TABLE appeal ADD CONSTRAINT fk_employee_creator FOREIGN KEY (creator_id) REFERENCES employee (id);
