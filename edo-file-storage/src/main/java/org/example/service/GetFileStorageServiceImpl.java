...
public class GetFileStorageServiceImpl implements GetFileStorageService {
     ...
     * В методе выполняется поиск файла по UUID, проверка соответствия формата имени файла
     ...
     * Метод выполняет поиск объекта по всем объектам в бакете,
     * используя регулярное выражение для проверки соответствия UUID в начале имени объекта.
     *
